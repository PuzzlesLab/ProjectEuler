...
public class P11LargestProductinAGrid 
{
    ...
    public static void main(String[] args) 
    {
        ...
        row = s1.split("\n");
        String[][] column = new String[20][20];
        for(int i=0;i<20;i++)
        {
        ...
        for(int i=0;i<20;i++)
        {
            for(int j=0;j<20;j++)
            {
                grid[i][j] = Integer.parseInt(column[i][j]);
        ...
        for(int i=0;i<20;i++)
            for(int j=0;j<17;j++)
            {
                ...
                if(max<product)
                {
                    //System.out.println("maxleft"+max);
                    max = product;
                }
            }
        ...
        System.out.println("up down max "+max);
        ...
        for(int i=0;i<17;i++)
        {
            for(int j=0;j<17;j++)
           {
                    ...
                    //System.out.println(" productd "+product);
                    if(max<product)
                        max = product;
        ...
        System.out.println("diagonal max "+max);
